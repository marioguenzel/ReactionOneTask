# E2EEvaluation
Evaluation framework for end-to-end analysis methods. This framework integrates many different end-to-end analysis methods and allows to evaluate them on different benchmarks. It is published as part of my master's thesis (TODO:Link).
